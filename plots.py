...
def radial_error_vs_ere_graph(all_radial_errors, all_expected_radial_errors, save_path, n_bin=36):
    ...
    plt.text(0.5, 0.075, "CORRELATION={:.2f}".format(correlation), backgroundcolor=(0.8, 0.8, 0.8, 0.8), size='x-large',
...
def reliability_diagram(all_radial_errors, all_mode_probabilities, save_path,
    ...
    plt.bar(bins[:-1], avg_acc_for_each_bin, align='edge', width=widths, color='blue', edgecolor='black',
